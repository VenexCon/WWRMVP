...
function PricingCard({ title, targetAudience, price, description }) {
  return (
    <div className="max-w-md rounded-lg md:w-2/3 h-90 overflow-hidden shadow-lg bg-blue-700 text-white border border-black">
      ...
      <Link
        to="/register"
        className="w-3/5 mb-3 mx-auto flex items-center justify-center gap-x-2 text-blue-600 bg-white font-medium rounded-lg text-lg x-5 py-2.5 text-center hover:border hover:border-black"
      >
